...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.goal.object.confidence
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.object.type.key = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.goal.object.type.db = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.goal.object.pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
