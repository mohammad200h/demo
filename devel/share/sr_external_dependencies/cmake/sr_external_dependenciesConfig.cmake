...
if(NOT "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/shadow_robot_ethercat/sr_external_dependencies/include " STREQUAL " ")
  set(sr_external_dependencies_INCLUDE_DIRS "")
  set(_include_dirs "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/shadow_robot_ethercat/sr_external_dependencies/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sr_external_dependencies' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/shadow_robot_ethercat/sr_external_dependencies/${idir}'.  ${_report}")
    endif()
