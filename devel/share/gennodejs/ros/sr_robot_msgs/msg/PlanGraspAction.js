...
class PlanGraspAction {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('action_goal')) {
        ...
        this.action_goal = new PlanGraspActionGoal();
      }
      if (initObj.hasOwnProperty('action_result')) {
        this.action_result = initObj.action_result
      }
      else {
        this.action_result = new PlanGraspActionResult();
      }
      if (initObj.hasOwnProperty('action_feedback')) {
        this.action_feedback = initObj.action_feedback
      }
      else {
        this.action_feedback = new PlanGraspActionFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PlanGraspAction
    // Serialize message field [action_goal]
    bufferOffset = PlanGraspActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = PlanGraspActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = PlanGraspActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PlanGraspAction
    let len;
    let data = new PlanGraspAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = PlanGraspActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = PlanGraspActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = PlanGraspActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += PlanGraspActionGoal.getMessageSize(object.action_goal);
    length += PlanGraspActionResult.getMessageSize(object.action_result);
    length += PlanGraspActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanGraspAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = PlanGraspActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new PlanGraspActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = PlanGraspActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new PlanGraspActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = PlanGraspActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new PlanGraspActionFeedback()
    }
...
module.exports = PlanGraspAction;
