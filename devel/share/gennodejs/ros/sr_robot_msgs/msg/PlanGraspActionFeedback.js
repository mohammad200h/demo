...
class PlanGraspActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PlanGraspFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlanGraspFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PlanGraspActionFeedback(null);
    ...
    data.feedback = PlanGraspFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanGraspActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PlanGraspFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PlanGraspFeedback()
    }
...
module.exports = PlanGraspActionFeedback;
