...
(cl:defmethod cl:initialize-instance :after ((m <GraspResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sr_robot_msgs-msg:<GraspResult> is deprecated: use sr_robot_msgs-msg:GraspResult instead.")))
