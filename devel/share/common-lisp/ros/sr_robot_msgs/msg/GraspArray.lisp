...
(cl:defclass <GraspArray> (roslisp-msg-protocol:ros-message)
  ((grasps
    :reader grasps
    :initarg :grasps
...
(cl:defclass GraspArray (<GraspArray>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <GraspArray>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'GraspArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sr_robot_msgs-msg:<GraspArray> is deprecated: use sr_robot_msgs-msg:GraspArray instead.")))

(cl:ensure-generic-function 'grasps-val :lambda-list '(m))
(cl:defmethod grasps-val ((m <GraspArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sr_robot_msgs-msg:grasps-val is deprecated.  Use sr_robot_msgs-msg:grasps instead.")
  (grasps m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GraspArray>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GraspArray>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <GraspArray>))
