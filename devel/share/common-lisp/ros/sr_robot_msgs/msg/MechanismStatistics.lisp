...
(cl:defclass <MechanismStatistics> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (actuator_statistics
    ...
    :type (cl:vector sr_robot_msgs-msg:ActuatorStatistics)
   :initform (cl:make-array 0 :element-type 'sr_robot_msgs-msg:ActuatorStatistics :initial-element (cl:make-instance 'sr_robot_msgs-msg:ActuatorStatistics)))
   (joint_statistics
    :reader joint_statistics
    :initarg :joint_statistics
    :type (cl:vector sr_robot_msgs-msg:JointStatistics)
   :initform (cl:make-array 0 :element-type 'sr_robot_msgs-msg:JointStatistics :initial-element (cl:make-instance 'sr_robot_msgs-msg:JointStatistics)))
   (controller_statistics
    :reader controller_statistics
    :initarg :controller_statistics
    :type (cl:vector sr_robot_msgs-msg:ControllerStatistics)
   :initform (cl:make-array 0 :element-type 'sr_robot_msgs-msg:ControllerStatistics :initial-element (cl:make-instance 'sr_robot_msgs-msg:ControllerStatistics))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MechanismStatistics>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MechanismStatistics)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sr_robot_msgs-msg:<MechanismStatistics> is deprecated: use sr_robot_msgs-msg:MechanismStatistics instead.")))
...
(cl:defmethod actuator_statistics-val ((m <MechanismStatistics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sr_robot_msgs-msg:actuator_statistics-val is deprecated.  Use sr_robot_msgs-msg:actuator_statistics instead.")
...
(cl:defmethod joint_statistics-val ((m <MechanismStatistics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sr_robot_msgs-msg:joint_statistics-val is deprecated.  Use sr_robot_msgs-msg:joint_statistics instead.")
  (joint_statistics m))
...
(cl:defmethod controller_statistics-val ((m <MechanismStatistics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sr_robot_msgs-msg:controller_statistics-val is deprecated.  Use sr_robot_msgs-msg:controller_statistics instead.")
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MechanismStatistics>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'actuator_statistics)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sr_robot_msgs-msg:ActuatorStatistics))
  ...
  (cl:let ((vals (cl:slot-value msg 'joint_statistics)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'sr_robot_msgs-msg:JointStatistics))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
  ...
  (cl:let ((vals (cl:slot-value msg 'controller_statistics)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'sr_robot_msgs-msg:ControllerStatistics))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MechanismStatistics>)))
  ...
  "sr_robot_msgs/MechanismStatistics")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MechanismStatistics)))
  "Returns string type for a message object of type 'MechanismStatistics"
  "sr_robot_msgs/MechanismStatistics")
