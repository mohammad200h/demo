...
(cl:defmethod cl:initialize-instance :after ((m <GraspGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sr_robot_msgs-msg:<GraspGoal> is deprecated: use sr_robot_msgs-msg:GraspGoal instead.")))

(cl:ensure-generic-function 'grasp-val :lambda-list '(m))
(cl:defmethod grasp-val ((m <GraspGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sr_robot_msgs-msg:grasp-val is deprecated.  Use sr_robot_msgs-msg:grasp instead.")
  (grasp m))

(cl:ensure-generic-function 'pre_grasp-val :lambda-list '(m))
(cl:defmethod pre_grasp-val ((m <GraspGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sr_robot_msgs-msg:pre_grasp-val is deprecated.  Use sr_robot_msgs-msg:pre_grasp instead.")
  (pre_grasp m))
