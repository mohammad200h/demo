...
if("TRUE" STREQUAL "TRUE")
  set(sr_grasp_stability_SOURCE_PREFIX /home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/sr_tools/sr_grasp_stability)
  set(sr_grasp_stability_DEVEL_PREFIX /home/mamad/Demo/demo/devel)
  ...
  set(sr_grasp_stability_INSTALL_PREFIX /home/mamad/Demo/demo/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sr_grasp_stability' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/sr_tools/sr_grasp_stability/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT sr_grasp_stability_NUM_DUMMY_TARGETS)
      set(sr_grasp_stability_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::sr_grasp_stability::wrapped-linker-option${sr_grasp_stability_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR sr_grasp_stability_NUM_DUMMY_TARGETS "${sr_grasp_stability_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::sr_grasp_stability::wrapped-linker-option${sr_grasp_stability_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND sr_grasp_stability_LIBRARIES "${interface_target_name}")
