...
class regex_util():
    def __init__(self,path=None):
        if path == None :
            ...
            self.path = path+"/kuka_handlit_model/model.sdf"
            self.save_path = path+"/kuka_handlit_model/model_collision.sdf"
        self.file = None 
        print("reading file")
