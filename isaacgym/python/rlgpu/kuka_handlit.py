...
class Kuka_handlit(BaseTask):
    ...
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless):
        ...
        self.ff_pos = self.pos_orn_state[:,15,:3]
        self.ff_orn = self.pos_orn_state[:,15,3:7]
        self.mf_pos = self.pos_orn_state[:,20,:3]
        self.mf_orn = self.pos_orn_state[:,20,3:7]
        self.rf_pos = self.pos_orn_state[:,25,:3]
        self.rf_orn = self.pos_orn_state[:,25,3:7]
        self.th_pos = self.pos_orn_state[:,31,:3]
        self.th_orn = self.pos_orn_state[:,31,3:7]
        #cube
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        #self.franka_dof_speed_scales = torch.ones_like(self.kuka_handlit_dof_lower_limits)
        #self.franka_dof_speed_scales[[7, 8]] = 0.1
        #kuka_handlit_dof_props['effort'][7] = 200
       # kuka_handlit_dof_props['effort'][8] = 200
        ...
        kuka_pose.p = gymapi.Vec3(0.0,-0.91,0.8)
