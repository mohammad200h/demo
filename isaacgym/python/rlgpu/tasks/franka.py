...
class FrankaCabinet(BaseTask):
    ...
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless):
        ...
        print("device_type::type::",type(device_type))
        self.cfg = cfg
    ...
    def reset(self, env_ids):
        ...
        print("reset::self.franka_dof_lower_limits::shape::",self.franka_dof_lower_limits.size())
        print("reset::self.franka_dof_targets::shape::",self.franka_dof_targets.size())
        print("reset::self.franka_dof_targets::",self.franka_dof_targets)
        print("reset::self.franka_dof_targets[env_ids, :self.num_franka_dofs]::shape::",self.franka_dof_targets[env_ids, :self.num_franka_dofs].size())
        ...
        print("self.global_indices[env_ids, :2].flatten():: ",self.global_indices[env_ids, :2].flatten())
        print("self.frankas:: ",self.frankas)
        print("self.cabinets:: ",self.cabinets)
        ...
        print("reset::self.global_indices::shape::",self.global_indices.size())
        print("reset::multi_env_ids_int32",multi_env_ids_int32)
        print("reset::multi_env_ids_int32::shape::",multi_env_ids_int32.size())
