...
def retrieve_cfg(args, use_rlg_config=False):
    if use_rlg_config:
        ...
        elif args.task == "Kuka_handlit":
            return os.path.join(args.logdir, "kuka_handlit"), "cfg/train/rlg/rlg_kuka_handlit.yaml", "cfg/kuka_handlit.yaml"
        elif args.task == "Kuka":
            return os.path.join(args.logdir, "kuka"), "cfg/train/rlg/rlg_kuka.yaml", "cfg/kuka.yaml"
        ...
        if args.task == "BallBalance":
            ...
            return os.path.join(args.logdir, "kuka_handlit"), "cfg/train/rlpt/pytorch_ppo_kuka_handlit.yaml", "cfg/kuka_handlit.yaml"
        elif args.task == "Kuka":
            return os.path.join(args.logdir, "kuka"), "cfg/train/rlpt/pytorch_ppo_kuka.yaml", "cfg/kuka.yaml"
        elif args.task == "ShadowHand":
