...
echo_and_run cd "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/ros_ethercat/ros_ethercat_model"
...
echo_and_run /usr/bin/env \
    ...
    "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/ros_ethercat/ros_ethercat_model/setup.py" \
     \
    build --build-base "/home/mamad/Demo/demo/build/iiwa_pybullet_integration/shadow_dep/ros_ethercat/ros_ethercat_model" \
    install \
    --root="${DESTDIR-/}" \
