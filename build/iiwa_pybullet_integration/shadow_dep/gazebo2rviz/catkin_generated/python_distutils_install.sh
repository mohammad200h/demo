...
echo_and_run cd "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/gazebo2rviz"
...
echo_and_run /usr/bin/env \
    ...
    "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/gazebo2rviz/setup.py" \
     \
    build --build-base "/home/mamad/Demo/demo/build/iiwa_pybullet_integration/shadow_dep/gazebo2rviz" \
    install \
    --root="${DESTDIR-/}" \
