...
echo_and_run cd "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/sr_interface/sr_grasp"
...
echo_and_run /usr/bin/env \
    ...
    "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/sr_interface/sr_grasp/setup.py" \
     \
    build --build-base "/home/mamad/Demo/demo/build/iiwa_pybullet_integration/shadow_dep/sr_interface/sr_grasp" \
    install \
    --root="${DESTDIR-/}" \
