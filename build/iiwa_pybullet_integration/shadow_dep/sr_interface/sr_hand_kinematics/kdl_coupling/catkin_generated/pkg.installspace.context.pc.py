...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lkdl_coupling;/opt/ros/kinetic/lib/liborocos-kdl.so.1.3.2".split(';') if "-lkdl_coupling;/opt/ros/kinetic/lib/liborocos-kdl.so.1.3.2" != "" else []
