...
echo_and_run cd "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/sr_interface/sr_moveit_hand_config"
...
echo_and_run /usr/bin/env \
    ...
    "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/sr_interface/sr_moveit_hand_config/setup.py" \
     \
    build --build-base "/home/mamad/Demo/demo/build/iiwa_pybullet_integration/shadow_dep/sr_interface/sr_moveit_hand_config" \
    install \
    --root="${DESTDIR-/}" \
