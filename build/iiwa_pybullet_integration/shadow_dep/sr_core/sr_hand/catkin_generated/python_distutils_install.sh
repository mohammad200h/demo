...
echo_and_run cd "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/sr_core/sr_hand"
...
echo_and_run /usr/bin/env \
    ...
    "/home/mamad/Demo/demo/src/iiwa_pybullet_integration/shadow_dep/sr_core/sr_hand/setup.py" \
     \
    build --build-base "/home/mamad/Demo/demo/build/iiwa_pybullet_integration/shadow_dep/sr_core/sr_hand" \
    install \
    --root="${DESTDIR-/}" \
